...
public class GraphInput {
     ...
     * @returns  a hash table of (String, Vertex) pairs
     */
    public static Hashtable LoadSimpleGraph(SimpleGraph newgraph, String pathandfilename){ // construct the graph
        ...
        int n, linenum = 0;
        Hashtable table = new Hashtable();      // data structure
     ...
     * @param newgraph  a graph to add edges to. newgraph should already be initialized
     * @param pathandfilename  the name of the file, including full path.
     * @returns  Result a data structure consisting of SimpleGraph and the sum of capacities of edges which come out of "s" 
     */
    public static Result LoadGraph(SimpleGraph newgraph, String pathandfilename){ // construct the graph
    	// for return value
        ...
        while (line != null) {
            ...
            if (n==3) {
                ...
                if(v1.getName().equals("s")) res.Capacity += edgedata.intValue();
            }
            else {
                System.err.println("Error:invalid number of tokens found on line " +linenum+ "!");
                return null;
